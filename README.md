...
### Modified by GmodStore

Modified by GmodStore due to the `superuserPassword` and `replicationPassword` secrets not being read from Rancher answers, based on the official helm chart for stolon.
